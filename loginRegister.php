...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent fixed-top scrolled" id="navbar">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex">
                    <a href="loginsignup.php" class="btn btn-outline-light btn-sm">BACK TO LOGIN</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="content-wrapper">
        <div class="form-container" id="formContainer">
            <form action="php/register_process.php" method="POST" onsubmit="return completeRegistration();">
                ...
                <div class="form-content">
                    ...
                    <div class="form-step" data-step="3">
                        <div class="text-center">
                            ...
                            <div class="mt-4">
                                <a href="registerboat.php" class="btn btn-primary me-2">
                                    <i class="bi bi-ship"></i> Register a Vessel
                                </a>
                                <a href="web_user.html" class="btn btn-outline-primary">
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', function () {
            ...
            if (!registrationData) {
                alert('Please complete the initial registration first.');
